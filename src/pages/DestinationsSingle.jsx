  ...
  return (
    <>
      <Container containerWidth="lg">
        ...
        <Row>
          <Col xs={12} sm={4} md={3} lg={3} xl={3} margin={2} marginLg={4}>
            <CardImage
              imgUrl={destination.imgUrl}
              altText={destination.imgAlt}
            />
          </Col>

          <Col xs={12} sm={8} md={9} lg={9} xl={9} margin={4}>
            <Content maxWidth="none" spacing="minimal">
              {destination.description}
            </Content>

            <CtaButton
              to={`/destinations/edit/${destination.id}`}
              variant="success"
            >
              Edit Destination
            </CtaButton>
            ...
            <CtaButton
              variant="danger"
              onClick={() => onDeleteClick(destination.id)}
            >
              Delete Destination
            </CtaButton>
          </Col>
