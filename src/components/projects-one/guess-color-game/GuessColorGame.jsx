...
const GuessColorGame = () => {
  ...
  const [backgroundColor, setBackgroundColor] = useState(startBackgroundColor);
  ...
  function insertHexColors() {
    ...
    const generatedBackgroundHexColor =
      generatedHexColors[Math.floor(Math.random() * generatedHexColors.length)];
      ...
      <div className="guess-color--success-message">
        {successMessage !== undefined ? (
          successMessage ? (
            ...
            <p className="incorrect">Wrong color! Guess one more time.</p>
          )
        ) : null}
      </div>
    </div>
